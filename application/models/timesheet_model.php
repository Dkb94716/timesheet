...
// echo $this->db->last_query();die;
    ...
    function getTime($timesheet_id) {
        ...
        $query = $this->db->query('select timesheet_id,emp_id,disbursement,'
                . 'DATE_FORMAT(timesheet_date,\'%d %M %Y\') as timesheet_date,start_time,end_time,client_name,activity_name,subactivity_name,task_name,billable,time_units,time_minutes,comments,time_status,reason_to_reject,project_name'
