...
elseif ($controller == "project_assign_user_list") {
    $project_assign_user_list = "active";
}
...
elseif ($controller == "upload_task") {
    $upload_task = "active";
} 
elseif ($controller == "project_wise_report") {
    $project_wise_report = "active";
} 
...
elseif ($controller == "timesheet_report_pending") {
    $pending_report_list = "active";
} 
    ...
    <div id="sidebar-fusion-wrapper">
        ...
        <?php //if ($userPrimeryId != 1) { ?>
            <ul class="menu list-unstyled" style="top:80px;">
                ...
                <?php } ?>
                <?php if ( $arr_left_task->Add == 1 ) { ?>   
                    <li class="<?php echo $upload_task ?>">
                        <a href="<?php echo base_url(); ?>task/upload_task" class="no-ajaxify">
                            <i class="fa fa-fw  icon-compose"></i>
                            <span>Upload Task List</span>
                        </a>
                    </li>
                <?php } ?>
                <?php if ( $arr_left_task->Add == 1 ) { ?>   
                    <li class="<?php echo $project_wise_report ?>">
                        <a href="<?php echo base_url(); ?>report/project_wise_report" class="no-ajaxify">
                ...
                <?php if ($arr_left_report->View == 1 || $arr_left_report->PrintReport == 1 || $arr_left_report->ExportExcel == 1) { ?>
                    <li class="<?php echo $pending_report_list; ?>">
                        <a href="<?php echo base_url() ?>report/timesheet_report_pending" class="no-ajaxify">
                            <i class="fa fa-fw icon-graph-up-1"></i>
