                    ...
                    if (!empty($employee_detail)) {
                        ...
                        foreach ($employee_detail as $emp_detail) {
                            ...
                            <table width="100%" class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
                                ...
                                @$to = $to + $total;
                                $minut = $to / 60;
                                $total_hours_data = convertToHoursMins($minut);
                                //date('H:i', mktime(0,$minut));//gmdate("H:i", ($minut * 60));//changed by satish
                                ...
                                $forMinuteMurValCalculate = (int)$forMinuteMurVal[1]*0.0167;
                                $HourMurVal = $forMinuteMurVal[0]+$forMinuteMurValCalculate;
                                $FinalMurVal = $HourMurVal*$rate_mur;
                                //echo $emp_detail->emp_id.$employee_hour_rate['0']->user_id.$emp_detail->timesheet_date.$employee_hour_rate['0']->date; die;
                        ...
                        <tr style='mso-yfti-irow:3'>
                            ...
                            <?php } ?>
                            <td style="font-size:12px;  width:90px !important;text-align: center; "><?php     ?></td>
                            <td style="font-size:12px;  width:90px !important;text-align: center; "><?php //echo @$total_end_time;     ?></td>
                            <td style="font-size:12px;  width:90px !important;text-align: center;" > </td>
                            <td style="font-size:12px;  width:90px !important;text-align: center;" > </td>
                            <td style="font-size:11px;  width:90px !important;text-align: left;font-weight: bold;" ><?php echo convertToHoursMins($workmintes); ?></td>
