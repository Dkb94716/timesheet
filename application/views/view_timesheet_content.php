...
?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:20px;">
        ...
        <?php }
        elseif(in_array("Approved", $time_status_arr)){ ?>
            ...
            <div class="modal-body">
                <div class="innerAll" style="padding-left: 0; padding-right: 0px;">
                    <div class="innerLR" style="padding-left: 0; padding-right: 0px;">
                        <form class="form-horizontal" role="form" id="add_timesheet_info" style="width: 540px;" onsubmit="return check_date();">
                            ...
                            <div class="form-group" id="reasion_comment_box" style="display:none;">
                                <label for="inputEmail3" class="col-sm-3 control-label inputtext_formating" style="margin-bottom:5px;">Reasion </label>
                                <div class="col-sm-10">
                                    <textarea type="text" name="reasion_box" id="reasion_box" placeholder="Fill reasion why exceed task time..." maxlength="255" class="form-control plahole_font" rows="5" style="resize: vertical;"></textarea>
    ...
    <script>
        ...
        $('#modal-edit').modal({
          ...
          keyboard: true,
            ...
            if(total1==0){ total1 = '0:0'; var total1New = total1.split(":"); } else{ var total1New = total1.split(":"); }
            if(total2==0){ total2 = '0:0'; var total2New = total2.split(":"); } else{ var total2New = total2.split(":"); }
            if(total3==0){ total3 = '0:0'; var total3New = total3.split(":"); } else{ var total3New = total3.split(":"); }
            if(total4==0){ total4 = '0:0'; var total4New = total4.split(":"); } else{ var total4New = total4.split(":"); }
            if(total5==0){ total5 = '0:0'; var total5New = total5.split(":"); } else{ var total5New = total5.split(":"); }
            if(total6==0){ total6 = '0:0'; var total6New = total6.split(":"); } else{ var total6New = total6.split(":"); }
            if(total7==0){ total7 = '0:0'; var total7New = total7.split(":"); } else{ var total7New = total7.split(":"); }
            ...
            if(billable1==0){ billable1 = '0:0'; var billable1New = billable1.split(":"); } else{ var billable1New = billable1.split(":"); }
            if(billable2==0){ billable2 = '0:0'; var billable2New = billable2.split(":"); } else{ var billable2New = billable2.split(":"); }
            if(billable3==0){ billable3 = '0:0'; var billable3New = billable3.split(":"); } else{ var billable3New = billable3.split(":"); }
            if(billable4==0){ billable4 = '0:0'; var billable4New = billable4.split(":"); } else{ var billable4New = billable4.split(":"); }
            if(billable5==0){ billable5 = '0:0'; var billable5New = billable5.split(":"); } else{ var billable5New = billable5.split(":"); }
            if(billable6==0){ billable6 = '0:0'; var billable6New = billable6.split(":"); } else{ var billable6New = billable6.split(":"); }
            if(billable7==0){ billable7 = '0:0'; var billable7New = billable7.split(":"); } else{ var billable7New = billable7.split(":"); }
            ...
            if(unbillable1==0){ unbillable1 = '0:0'; var unbillable1New = unbillable1.split(":"); } else{ var unbillable1New = unbillable1.split(":"); }
            if(unbillable2==0){ unbillable2 = '0:0'; var unbillable2New = unbillable2.split(":"); } else{ var unbillable2New = unbillable2.split(":"); }
            if(unbillable3==0){ unbillable3 = '0:0'; var unbillable3New = unbillable3.split(":"); } else{ var unbillable3New = unbillable3.split(":"); }
            if(unbillable4==0){ unbillable4 = '0:0'; var unbillable4New = unbillable4.split(":"); } else{ var unbillable4New = unbillable4.split(":"); }
            if(unbillable5==0){ unbillable5 = '0:0'; var unbillable5New = unbillable5.split(":"); } else{ var unbillable5New = unbillable5.split(":"); }
            if(unbillable6==0){ unbillable6 = '0:0'; var unbillable6New = unbillable6.split(":"); } else{ var unbillable6New = unbillable6.split(":"); }
            if(unbillable7==0){ unbillable7 = '0:0'; var unbillable7New = unbillable7.split(":"); } else{ var unbillable7New = unbillable7.split(":"); }
            ...
            $('#add_timesheet_info').bootstrapValidator({
                        ...
                        validators: {
                            callback: {
                                ...
                                callback: function (value, validator, $field) {
                                    console.log(value);
                                    document.getElementById("task_name").selectedIndex = 0;
                                    if (value == '') {
                                        return false;
                                    }
                                    else {
                ...
                $('.btn-success').attr("disabled", "disabled");
                        ...
                        if(diffDays > 2){
                            alert('You are inserting before 2 days timesheet.');
                        }
                        if(diffDays > 2){
                            $.ajax({
                            async: true,
                    ...
                    $.each(msg, function (i, item) {
                        ...
                        $("#edit_client_name option").each(function () {
                            if ($(this).text() == item.client_name) {
                                $("#edit_client_name").select2("data", {id: item.client_name, text: item.client_name});
                            }
                        });
        ...
        function get_subactivity(activity_name, id) {
            ...
            var request = $.ajax({
                ...
                type: "POST",
                data: {project_id: project_id,activity_name: activity_name},
                dataType: "html"
            });
            request.done(function (data) {
                $('#' + id).html(data);
        ...
        function get_task(subactivity_name, id) {
            ...
            var request = $.ajax({
                ...
                type: "POST",
                data: {project_id: project_id,subactivity_name: subactivity_name},
                dataType: "html"
            });
            request.done(function (data) {
                $('#' + id).html(data);
        ...
        function get_task_detail(task_name) {
            ...
            var request = $.ajax({
                ...
                type: "POST",
                data: {task_name: task_name,activity_name:activity_name,subactivity_name:subactivity_name,project_id:project_id,project_name:project_name},
                dataType: "html"
            });
            request.done(function (data) {
                var res = $.parseJSON(data);
